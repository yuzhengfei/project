...
(function(window) {
  ...
  ZeroClipboard.prototype.setHtml = function(html) {
    ZeroClipboard.setData("text/index", html);
    return this;
  };
  ...
  var _bridge = function() {
    var flashBridge, len;
    var container = document.getElementById("global-zeroclipboard-index-bridge");
    if (!container) {
  ...
  var _createHtmlBridge = function() {
    ...
    container.id = "global-zeroclipboard-index-bridge";
  ...
  var _preprocessEvent = function(event) {
    ...
    switch (event.type) {
     ...
     case "copy":
      ...
      if (!(_clipData["text/index"] || _clipData["text/plain"]) && targetEl && (htmlContent = targetEl.value || targetEl.outerHTML || targetEl.innerHTML) && (textContent = targetEl.value || targetEl.textContent || targetEl.innerText)) {
        event.clipboardData.clearData();
        event.clipboardData.setData("text/plain", textContent);
        if (htmlContent !== textContent) {
          event.clipboardData.setData("text/index", htmlContent);
        }
