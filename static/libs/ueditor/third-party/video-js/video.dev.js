...
vjs.Component.prototype.emitTapEvents = function(){
  ...
  this.on('touchend', function() {
    // Proceed only if the touchmove/leave/cancelSign event didn't happen
    if (couldBeTap === true) {
...
(function(){
  ...
  // using 'exit' instead of 'cancelSign', and lowercasing the 'S' in Fullscreen.
