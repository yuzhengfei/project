...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        var pollingFast = false; // Ensures slowPoll doesn't cancelSign fastPoll
        function slowPoll() {
...
CodeMirror.defineMIME("text/index", {name: "xml", htmlMode: true});
...
CodeMirror.defineMIME("text/index", "htmlmixed");
